...
var validateField = (function (fieldsRef, validateAllFieldCriteria, _a, shallowFieldsStateRef) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var name, error, isRadio, isCheckBox, isRadioOrCheckbox, isEmpty, appendErrorsCurry, getMinMaxMessage, _c, value_1, message, exceedMax, exceedMin, maxOutput, minOutput, valueNumber, valueDate, maxLengthOutput, minLengthOutput, exceedMax, exceedMin, _d, patternValue, message, fieldValue, validateRef, result, validateError, validationResult, _e, _f, _g, key, validateFunction, validateResult, validateError, e_1_1;
        var e_1, _h;
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    if (required &&
                        ...
                        _c = isMessage(required)
                            ...
                            : getValueAndMessage(required), value_1 = _c.value, message = _c.message;
                        if (value_1) {
                    ...
                    if (pattern && !isEmpty) {
                        _d = getValueAndMessage(pattern), patternValue = _d.value, message = _d.message;
                ...
                case 3:
                    ...
                    _e = __values(Object.entries(validate)), _f = _e.next();
                    _j.label = 4;
                case 4:
                    if (!!_f.done) return [3 /*break*/, 7];
                    _g = __read(_f.value, 2), key = _g[0], validateFunction = _g[1];
                    if (!isEmptyObject(validationResult) && !validateAllFieldCriteria) {
                        return [3 /*break*/, 7];
                    }
                    return [4 /*yield*/, validateFunction(fieldValue)];
                case 5:
                    validateResult = _j.sent();
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!error && resolverRef.current) {
                                parentNodeName = name.substring(0, name.lastIndexOf('.') > name.lastIndexOf('[')
                                    ? name.lastIndexOf('.')
                                    : name.lastIndexOf('['));
...
var useFieldArray = function (_a) {
    ...
    var batchStateUpdate = function (method, args, updatedFieldValues, updatedFormValues, shouldSet, shouldUpdateValid) {
        ...
        updateFormState({
            errors: formStateRef.current.errors,
            dirtyFields: formStateRef.current.dirtyFields,
            isDirty: isFormDirty(name, updatedFormValues.map(function (_a) {
                if (_a === void 0) { _a = {}; }
    ...
    var append = function (value, shouldFocus) {
        ...
        var updateFormValues = __spread(getFieldArrayValue(), mapIds(Array.isArray(value) ? value : [value], keyName));
...
var Controller = function (_a) {
    ...
    var props = __assign(__assign({}, rest), commonProps);
    return as
